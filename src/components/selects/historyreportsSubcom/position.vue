            ...
            <div class="table-1">
              <div class="flex s_bg">
                ...
                <div class="s_bg_flex_right">
                  <button type="submit" id="exportBtn" @click="exportExcel('tableHeader','tableBody','历史持仓汇总','历史持仓汇总.xls','exportBtn')" class="btn btn-primary" style="float:right;font-size:12px;color:#fff">
              ...
              <table class="table table-1-1" id="tableHeader">
                <thead>
                  <tr>
                    ...
                    <th style="width: 8%">持卖均价</th>
                    <th style="width: 5%">持买量</th>
                    <th style="width: 8%">持买均价</th>
            ...
            <table class="table table-hover table-2-1" id="tableBody">
              <tbody>
                ...
                <tr v-for="(item,index) in PositionList" :key="index">
                  ...
                  <td style="width: 8%">{{Math.round(item.HoldSalePrice*100)/100}}</td>
                  <td style="width: 5%">{{item.HoldBuyVolume}}</td>
                  <td style="width: 8%">{{Math.round(item.HoldBuyPrice*100)/100}}</td>
    ...
    <div class="mask">
      <div class="mask_box" style="width:55%;">
        <div class="panel panel-default  no-border">
          <div class="panel-heading">历史持仓详情</div>
...
export default {
  ...
  methods: {
    getPositionList(isSearch = true) {
      ...
      if (AgentValue == "") {
        url = "/report/QryAllUserPositionStatis";
        postData = {
        ...
        url = "/report/QryInsUserPositionStatis";
        postData = {
          ContactNO: this.ContactNoValue,
          BeginDate: this.DateRangeValue[0],
          EndDate: this.DateRangeValue[1],
        ...
        url = "/report/QryAgentUserPositionStatis";
        postData = {
          AgentCode: "",
          ContactNO: this.ContactNoValue,
          BeginDate: this.DateRangeValue[0],
