<template>
  <div class="s-height agentwithAuth_">
    <div class="template">
      <article class="main">
            ...
            <div class="table-1">
              <div class="flex s_bg">
                ...
                <div class="s_bg_flex_right">
                  <button type="submit" id="exportBtn" @click="exportExcel('tableHeader','tableBody','经纪人提现审核汇总','经纪人提现审核汇总.xls','exportBtn')" class="btn btn-primary" style="float:right;font-size:12px;color:#fff">
    ...
    <div class="mask auditDialog" v-loading="loadingsave" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.6)">
      <div class="mask_box" style="width:55%;">
        <div class="panel panel-default  no-border">
          <div class="panel-heading">经纪人提现审核</div>
  ...
  methods: {
    ...
    getwithdrawList() {
      ...
      this.$loginapi.postWithPage(
        "/WithDrawMgr/GetNoAuditedListByInsAgent",
        this.pager.PageNo,
        this.pager.PageSize,
