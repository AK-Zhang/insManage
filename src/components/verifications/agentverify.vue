<template>
  <div>
    <div class="template agentverify_">
      <article class="main">
                  ...
                  <table class="table table-hover">
                    <tbody>
                      ...
                      <tr v-for="(item,index) in verifylist1" :key="index">
                        ...
                        <td style="width:20%">{{item.Status == 0 ? "已申请" : (item.Status == 1 ? "审核已通过" : "审核未通过")}}</td>
                        <td style="width:14%">
                          <a id="param-edit" @click="showUpdatePage(item,1,false)" style="color:#337ab7;">审核</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
    ...
    <div class="mask" v-loading="loadingsave" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(0, 0, 0, 0.6)">
              ...
              <div class="wei6">
                ...
                <div class="formin">
                  ...
                  <div class="imgbox">
                    ...
                    <video :src="Videourl" controls="controls" style="width:30%;display:inline-block;vertical-align: top;  z-index: 99999999;"></video>
                  </div>
      ...
      <el-dialog :visible.sync="Backimgdialog" :modal-append-to-body=false width="30%">
        <img :src="Backimgurl" alt="身份证反面" style="width:100%;height:50%">
      </el-dialog>
    </div>
...
export default {
  ...
  created() {
    this.$store.state.loaction = "/verifications/agentverify";
  ...
  methods: {
    ...
    pass6() {
      if (this.val.indexOf("视频审核不通过") == -1) {
        this.val = this.val + "视频审核不通过";
      }
      $("#auditpassd").attr("disabled", "disabled");
    },
    //    分页
