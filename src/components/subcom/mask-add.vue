  ...
  <div class="mask">
    <div class="mask_box">
      <div class="panel panel-default  no-border">
        ...
        <div class="panel-heading">编辑基准保证金</div>
        <div class="panel-body">
          <form class="form-inline form-inline1" novalidate="" role="form">
            <div>
              ...
              <span class="selected">
                <input class="input-text input-text-bg" type="text" v-model="objs.CommodityName" readonly="true">
              </span>
              <div class="error3">
                按手数
              </div>
              <span class="selected">
                <input class="input-text" type="text" v-model="objs.ByNumber">
                <div class="input-list">{{objs.TradeCurrency}}</div>
              </span>
            </div>
          </form>
        </div>
        ...
        <p>
          ...
          <span class="fr">
            <button type="button" class="btn btn-info btn-saved" @click="Modifydata(objs,objs.CommodityName)">保存</button>
          </span>
          <span class="fr">
