            ...
            <div class="panel-heading">
              <h3 class="panel-title flex">
                ...
                <ol class="breadcrumb breadcrumb-top">
                  ...
                  <li class="active">经纪人手续费模板</li>
                </ol>
              </h3>
            </div>
            <div class="panel-body bg">
              <p>
                <span class="col-md-10 fz">经纪人手续费模板，可对经纪人手续费模板进行新增、编辑、删除 操作</span>
                ...
                <tbody>
                  ...
                  <tr v-for="(item,index) in list">
                    ...
                    <td style="width:6%" class="sub-checked" id="sub-checked">
                      <input type="checkbox" :class="ClassName+index" @click="selectedSub(item.TpCode,index)"></td>
                    <td style="width:15%">
      ...
      <div class="mask_box clear">
        <div class="panel panel-default  no-border clear">
            ...
            <div class="content clear">
              <form class="form-inline form-inline1" novalidate="" role="form">
                <div class="clear">
                  ...
                  <span class="selected">
                    <input class="input-text" type="text" v-model="AddName">
                  </span>
                  <div class="error3">
                    <span class="error4"> </span>
                    模板说明
          ...
          <p>
            ...
            <span class="fr">
              <button type="button" class="btn btn-info" @click="ModifydataAdmin('',AddName,AddRemark,CommodityList)">保存</button>
            </span>
            <span class="fr">
            ...
            <div class="content clear">
              <form class="form-inline form-inline1" novalidate="" role="form">
                <div class="clear">
                  ...
                  <span class="selected">
                    <input class="input-text" type="text" style="width:100%" v-model="EditName">
                  </span>
                  <div class="error3">
                    <span class="error4"> </span>
                    模板说明
...
export default {
  ...
  created() {
    ...
    this.getlist();
    //this.ModifydataAngent("agent001","","1003下经纪人1","1003下经纪人1");
    //this.getDetaillist("");
  },
  methods: {
    /*  agent001 如果是经纪人传入经纪人编号 */
    getlist(num) {
      if (num == undefined) {
        this.loading = true;
      }
    ...
    getDetaillist(ID) {
      ...
      this.$loginapi.post(url, ID, response => {
        if (response.Ret == 0) {
          ...
          this.$router.push("/templates/agentfeetemplatesinfo");
        } else {
          //this.$message.error(response.Msg); //请求失败，response为失败信息
          this.$alert(response.Msg, {});
        }
    ...
    getCommoditylist(ID) {
      var url = "/instp/QueryInsAgentFeeTpDetail";
      this.$loginapi.post(url, ID, response => {
        if (response.Ret == 0) {
          //console.log(response.Data); //请求成功，response为成功信息参数
      ...
      this.$loginapi.post(url, id, response => {
        ...
        if (response.Ret == 0) {
          ...
          if (this.list.length == 0) {
            this.$(".total-checked")[0].checked = false;
          }
    ...
    ModifydataAngent(AgentCode, TpCode, Name, Remark, Details) {
      if (Name.trim() == "") {
    ...
    AddNew(TpCode, Name, Remark, Details) {
      if (Name.trim() == "") {
        // this.$message.error("经纪人手续费模板名称不能为空");
        this.$alert("经纪人手续费模板名称不能为空", {});
        return;
